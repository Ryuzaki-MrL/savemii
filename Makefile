...
CFLAGS	:=  -std=gnu11 -mrvl -mcpu=750 -meabi -mhard-float -ffast-math \
		    -O3 -D__wiiu__ -Wall -Wextra -Wno-unused-parameter -Wno-strict-aliasing $(INCLUDE) $(DEFS)
...
#---------------------------------------------------------------------------------
LIBS	:= -ldynamiclibs -lfat -liosuhax -lfreetype -lpng -lz -lm
...
clean:
	@echo clean ...
	@rm -fr $(BUILD) $(CURDIR)/*.elf $(BUILD_DBG).elf
